...
[`../evaluation/d6_cost_model.ipynb`](../evaluation/d6_cost_model.ipynb), with machine-readable
output in [`../results/d6_cost_model.json`](../results/d6_cost_model.json). Inputs are audited in
[`D6-input-audit.md`](D6-input-audit.md).*
...
| 2 · Turn count `T` | the quadratic history term | 222 turns, 413,515 input tokens | 183 turns, 353,481 input tokens | D2(c) |
...
turns from **222 to 183** and input tokens from **413,515 to 353,481**, while decisions stay
**40/42** in both arms.
