...
**Owners:** JIN CHENG · NIU TONG record them; each strand owner checks their own.
*Deadlines: [`../PLAN.md`](../PLAN.md).*

> 🚧 **Empty until the runs happen.** The table below is what will be here, not what is here.
...
|---|---|---|
| `pass-rates.md` | D4, D5 | Pass rate per **prompt version** and per model, with trial count, model id and date |
...
| `model-battery.md` | D5 | All five models side by side — and where they diverged on the negative cases |
