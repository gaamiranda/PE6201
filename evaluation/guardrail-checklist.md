...
| 5 | Verbose reply whose projected cost crosses `US$0.019` | Unbounded spend | Loop control | `cap_fired=budget_ceiling` at `US$0.02478`; escalation with reason beginning `STOPPED BY GUARDRAIL: budget_ceiling`. No decision letter written. | **Yes** |
